"""
Admin Login View
Handles the UI components and user interactions for admin login
"""
...
class AdminLoginView(QWidget):
    ...
    def _init_ui(self):
        ...
        # Admin ID or Email
        username_label = QLabel("Admin ID or Email")
        username_label.setFont(QFont("Arial", 12))
        username_label.setStyleSheet("color: black;")
        username_label.setAlignment(Qt.AlignmentFlag.AlignLeft)

        self.identifier_input = QLineEdit()
        self.identifier_input.setPlaceholderText("Enter your Admin ID or Email")
